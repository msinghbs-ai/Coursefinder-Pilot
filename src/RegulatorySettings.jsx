...
export default function RegulatorySettings({ onError }) {
  ...
  return <div className="stack">
    ...
    <section className="panel full ingestion-control">
      <div className="panel-title control-title"><div><span className="kicker">7 countries · controlled Layer 1 UAT</span><h3>Layer 1 ingestion control</h3><p>One Edge Function invocation orchestrates Australia, Canada, Germany, United Kingdom, Ireland, New Zealand and United States. Live machine sources are used where available; preserved core Layer 1 seed is used where the official register is not a structured course feed.</p></div><span className="control-badge"><ShieldCheck size={15}/>Platform Admin</span></div>
