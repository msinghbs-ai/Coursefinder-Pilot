...
export default function RegulatorySettings({ onError }) {
  ...
  return <div className="stack">
    ...
    <section className="panel full ingestion-control">
      <div className="panel-title control-title"><div><span className="kicker">Australia · CRICOS · controlled UAT</span><h3>Layer 1 ingestion control</h3><p>CRICOS runs now execute as one Supabase Edge Function invocation, using the proven demo ETL pattern against the v2.9.1 service contract.</p></div><span className="control-badge"><ShieldCheck size={15}/>Platform Admin</span></div>
