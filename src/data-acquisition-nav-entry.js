...
function clickButton(label){const b=button(label);if(b)b.click()}
...
function install(){
  ...
  const style=document.createElement('style');style.dataset.acquisitionNavStyle='1';style.textContent='.ops-launcher,.l2-launcher,.l2p-launcher{display:none!important}.acquisition-nav-item.active{background:linear-gradient(90deg,#283650,#243147);color:#fff;box-shadow:inset 3px 0 0 #7c83ff}.m-shell.is-collapsed .acquisition-nav-item span{display:none}'
