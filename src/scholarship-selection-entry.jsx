...
export function ScholarshipSelectionWorkspace({onClose}){const[courseId,setCourseId]=useState(''),[data,setData]=useState(null),[busy,setBusy]=useState(false),[error,setError]=useState('')
