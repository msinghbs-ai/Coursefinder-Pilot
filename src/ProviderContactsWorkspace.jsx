...
function ImportPanel({onClose,onApplied,onError}){
...
export default function ProviderContactsWorkspace({rank,onError,navigate,initialProviderId=''}) {
 ...
 {importOpen&&<ImportPanel onClose={()=>setImportOpen(false)} onApplied={load} onError={onError}/>}
 </div>
}
