...
function OutcomeCard({x,navigate}){
 ...
 return <article className="ci-outcome-card">
  ...
  {x.response_count!=null&&<div className="ci-responses">Based on {Number(x.response_count).toLocaleString()} responses</div>}
