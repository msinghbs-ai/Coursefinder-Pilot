...
function Builder(){
 ...
 const canRun=Boolean(preview?.preview_token)&&preview?.executable===true&&!busy&&mode==='acquisition_only'

 const invalidatePreview=()=>{previewGeneration.current+=1;setPreview(null);setMessage('');setBusy(false)}
