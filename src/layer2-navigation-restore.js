...
// Package 3 (Decision 116): Layer 1-4 shortcuts are no longer injected into the Administration
// tab row; Layer execution lives in the Data Operations menu only.
...
function reconcile(){ensureSidebarSequence()}
let pending=false
