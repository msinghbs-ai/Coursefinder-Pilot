...
test('v2.15.96 is the release candidate while v2.15.79 remains the accepted recovery release and v2.15.78 retained history',()=>{
  ...
  expect(manifest).toContain("export const UI_VERSION='2.15.96'")
  expect(manifest).toContain("export const PACKAGE_VERSION='0.1.23'")
  ...
  expect(changelog).toContain('## 0.1.23 — 26 Sep 2026')
  expect(changelog).toContain('**v2.15.96**')
