...
test('v2.15.84 is the release candidate while v2.15.79 remains the accepted recovery release and v2.15.78 retained history',()=>{
  ...
  expect(manifest).toContain("export const UI_VERSION='2.15.84'")
  expect(manifest).toContain("export const PACKAGE_VERSION='0.1.11'")
  ...
  expect(changelog).toContain('## 0.1.11 — 24 Sep 2026')
  expect(changelog).toContain('**v2.15.84**')
  expect(changelog).toContain('## 0.1.10 — 24 Sep 2026')
  expect(changelog).toContain('**v2.15.83**')
