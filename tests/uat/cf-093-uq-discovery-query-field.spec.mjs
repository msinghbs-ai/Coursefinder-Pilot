...
test('CF-093 keeps discovery query selection profile-scoped and preserves CRICOS detail verification',()=>{
 expect(worker).toContain('layer2-scope-discover-scheduled-v1.3.4')
