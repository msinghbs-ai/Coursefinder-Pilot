...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    for (const c of cases || []) {
      ...
      const expectedOutcome = "resolve_candidate";
    ...
    const synthetic = [
      {
        ...
        text: 'International tuition fee: AUD 56,800 is listed as "per semester" for the 2026 programme, with no annual figure stated anywhere on the page. International tuition fee 2027: AUD 59,000 per year applies to a later intake of the same programme.',
      },
      {
