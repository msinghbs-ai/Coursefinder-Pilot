...
const VERSION = "ranking-the-url-import-v2.0.0";
...
Deno.serve(async (req: Request) => {
  ...
  return reply(req, 410, {
    ok: false,
    error: "the_url_acquisition_retired",
    detail: "THE ranking ingestion now uses authorised THE workbook Evidence followed by ranking-the-official-etl. Parse.bot-backed URL acquisition is retired.",
    edition_year: Number.isInteger(year) ? year : null,
    required_worker: "ranking-the-official-etl",
    evidence_format: "THE XLSX",
