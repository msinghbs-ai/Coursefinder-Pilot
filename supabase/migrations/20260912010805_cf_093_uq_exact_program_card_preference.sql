...
begin
  ...
  v_cfg:=jsonb_set(v_cfg,'{discovery_strategy,candidate_exact_title_preference}','true'::jsonb,true);
  ...
  insert into pipeline.layer2_source_profile_versions(
    ...
    'valid',v_validation,'CF-CHG-20260910-093','CF-093-UQ-exact-program-card-preference'
