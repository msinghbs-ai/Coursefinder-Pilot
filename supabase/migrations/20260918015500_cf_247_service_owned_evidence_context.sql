-- CF-CHG-20260915-247
-- Keep private pipeline Evidence metadata server-side: return the already-validated
-- Evidence locator and current attempt count from the service-role reservation RPC.
begin;
