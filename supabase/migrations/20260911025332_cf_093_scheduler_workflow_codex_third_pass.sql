...
-- CF-CHG-20260910-093 Codex third-pass correction.
-- Re-prove live runnable work at dispatch after preview so a profile paused/disabled
-- after preview cannot consume a token as a successful no-op. Preserve all prior
-- exact-target, rank, mode, preview-token and idempotency boundaries.
