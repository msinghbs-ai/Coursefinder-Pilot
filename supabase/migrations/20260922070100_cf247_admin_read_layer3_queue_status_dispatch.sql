-- CF-CHG-20260915-247, Track G. Purely additive: one new dispatch branch
-- for 'layer3_queue_status', inserted after 'scholarship_ai'. Every other
-- branch is copied verbatim, unchanged, in its original order.
--
