...
-- CF-CHG-20260910-093
-- Codex correction: scheduler search treats operator input literally. PostgreSQL
-- LIKE metacharacters are escaped before the existing rank-gated predicates run.
