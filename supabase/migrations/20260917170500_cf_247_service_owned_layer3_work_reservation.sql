-- CF-CHG-20260915-247
-- Forward-only Gate-D bridge from durable Layer 3 work items into the existing
-- interpretation audit/provenance path. Service role only; candidate_context is
-- loaded from the persisted work item and never accepted from a browser caller.
