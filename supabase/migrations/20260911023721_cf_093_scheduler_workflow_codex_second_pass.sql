...
-- CF-CHG-20260910-093 Codex second-pass correction.
-- Preserve exact-scope idempotency from dispatch time, require runnable current
-- Layer 2 profile versions at preview and dispatch, and canonicalise country scope.
